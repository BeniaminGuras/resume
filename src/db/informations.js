export const personal = [
  ...
  {
    type: "text",
    title: "Ambitions, plans, dreams",
    description:
      "I would love to visit the USA, maybe for a little bit longer - play with real Amercian basketball team and eat a hamburger from the bar.",
  },
];
...
export const professional = [
  {
    ...
    description:
      "I wrote my first code when I was 11. Since then, I've had plenty of opportunities to code in multiple languages. I graduated from high school with an IT profile - there I had the opportunity to work with frontend technologies, over there I learned HTML, JavaScript and CSS. Then I focused on C ++ and Python. A few years later, I signed myself for the Frontend React developer bootcamp where I added React, React Router and Redux to my skills list.",
  },
  {
    type: "text",
    title: "Experience",
  ...
  },
  {
    ...
    list: [
      "IT Administrator (Simoldes Plasticos)",
      "Developer (Self-employment)",
      "Logistic Specialist (Simoldes Plasticos)",
      "Junior Logisitic Specialist (Simoldes Plasticos)",
    ],
  },
  {
    type: "text",
    ...
    description:
      "As a curious and ambitious person, I would like to develop my skills in the most universal way. That's why my focus is on becoming a fullstack developer. Which would allow me to develop not only in one direction. To make this a reality in the near future, I plan to add node.js to my technology stack.",
  },
];
...
export const recentProject = [
  ...
  },
  {
    ...
    description:
      "Website Application that allows waiters to manage the table status. It has been written with React, React Router, React Bootstrap, Redux. It's dynamically communicating the changes with API.",
  ...
  },
  {
    ...
    description:
      "Demo of form that generates the questions conditianlly. After submiting it checks the correctness of filled inputs - if it's ok it starts communication with API. Demo is created in React.",
  ...
  },
  {
    ...
    description:
      "On the website we can dynamically generate categories and a lists of to do tasks with customizable icons. It has been created with React, React Router, Redux.",
  ...
  },
  {
    ...
    description:
      "Component accepts the list of elements that will be searched for a writen phrase. After finding a match it allows the client to select and automatically add the word or number as a tag. It has been created with React.",
